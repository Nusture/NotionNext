...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '5aa7f787c0b24d4398a57a09d081719c',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Marx Xu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.nusture.top/', // 网站地址
  ...
  /*
  * TsangerJinKai05 仓耳今楷05
  * MiSans VF 小米字体
  * */
  FONT_URL: [
    // 'https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css',
    // '/fonts/TsangerJinKai05.tff',
    '/fonts/MiSans VF.ttf',
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '粤ICP备2021149148号', // 备案号 闽ICP备XXXXXXX
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || '2SO780TCNV', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || 'dee2d574a8e1d38e3a812f5d79bac3f0', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_SEARCH_ONLY_APP_KEY: process.env.NEXT_PUBLIC_ALGOLIA_SEARCH_ONLY_APP_KEY || '94a9d30cc26f420c7172c5f2d34b320a', // 客户端搜索用的KEY
  ...
  // 漂浮线段特效
  NEST: process.env.NEXT_PUBLIC_NEST || false, // 开关false
  // 动态彩带特效
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://www.nusture.top/twikoo', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'luot7pz0jf', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
